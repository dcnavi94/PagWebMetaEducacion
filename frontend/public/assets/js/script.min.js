document.addEventListener("DOMContentLoaded", () => {
  ...
  (document.querySelectorAll("a.nav-link").forEach((e) => {
    ...
    window.addEventListener("scroll", () => {
      window.scrollY > 50
        ? (e.classList.add("shadow-lg"), (e.style.opacity = "0.98"))
        : (e.classList.remove("shadow-lg"), (e.style.opacity = "1"));
    }));
  ...
  document.querySelectorAll("[data-bg]").forEach((e) => a.observe(e));
  const n = document.getElementById("heroCarousel");
  n &&
    n.addEventListener("slide.bs.carousel", (e) => {
      const a = e.relatedTarget;
      a.dataset.bg && (a.style.background = a.dataset.bg);
    });
  const o = [
      {
        keywords: [
      ...
      },
      {
        ...
        answer:
          "✅ ¡Sí! Todos nuestros programas cuentan con <b>RVOE</b> (Reconocimiento de Validez Oficial de Estudios) ante la <b>SEG (Secretaría de Educación de Guanajuato)</b>.\n\nTu título es <b>100% válido a nivel nacional</b>. Puedes estar tranquilo, tu inversión está respaldada. 🎓",
      },
      {
        keywords: [
          "ubicacion",
      ...
      },
      {
        ...
        answer:
          "¡Hasta pronto! 👋 Fue un gusto ayudarte. Recuerda que MetaEducación siempre está aquí para ti.\n\n¡Te esperamos en la <b>Legión Axolot</b>! 🦎💚",
      },
      {
        keywords: [
          "axo",
    ...
    s = document.getElementById("axoChatToggle"),
    r = document.getElementById("axoChatWindow"),
    i = document.getElementById("axoChatClose"),
    c = document.getElementById("axoChatMessages"),
    l = document.getElementById("axoChatInput"),
    d = document.getElementById("axoChatSend"),
    u = document.querySelectorAll(".axo-quick-btn"),
    b = document.querySelector(".axo-toggle-badge");
  let p = !1,
    m = !1,
    g = null;
  function f() {
    ((p = !1),
      r.classList.remove("axo-open"),
      s.classList.remove("axo-hidden"));
  }
  function y() {
  ...
  function h(e) {
    ...
    ((a.className = "axo-msg axo-msg-bot"),
      (a.innerHTML = `\n            <div class="axo-msg-avatar">\n                <img src="assets/images/axo-polo-laptop.png" alt="Axo">\n            </div>\n            <div class="axo-msg-bubble">${e.replace(/\n/g, "<br>")}</div>\n        `),
      c.appendChild(a),
      E());
  }
  function v(e) {
    const a = document.createElement("div");
    ((a.className = "axo-msg axo-msg-user"),
      (a.innerHTML = `\n            <div class="axo-msg-bubble">${(function (
        e,
      ) {
        const a = document.createElement("div");
  ...
  function w() {
    ...
    ((e.className = "axo-msg axo-msg-bot"),
      (e.id = "axoTyping"),
      (e.innerHTML =
  ...
  function x() {
    const e = document.getElementById("axoTyping");
    e && e.remove();
  }
  function E() {
    setTimeout(() => {
      ...
      for (const t of e.keywords) {
        ...
        for (const e of s)
          for (const a of n)
            a === e
              ? (o += 2)
              : ((a.length > 3 && e.startsWith(a)) ||
                  (e.length > 3 && a.startsWith(e))) &&
                (o += 1);
      }
      o > s && ((s = o), (r = e.answer));
    }
    return s >= 2 && r ? r : t[Math.floor(Math.random() * t.length)];
  }
  (setTimeout(() => {
    p ||
      m ||
      (function () {
        ...
        g.className = "axo-welcome-tooltip";
        g.innerHTML = "👋 ¡Hola! Soy <b>Axo</b>. ¿Tienes dudas sobre MetaEducación? ¡Pregúntame!";
        const botEl = document.getElementById("axoChatbot");
        if (botEl) botEl.appendChild(g);
        setTimeout(() => {
          g &&
    ...
    s && s.addEventListener("click", () => {
      p
        ...
        : (function () {
            ((p = !0),
              r.classList.add("axo-open"),
              s.classList.add("axo-hidden"),
              (b && (b.style.display = "none")),
              g && g.parentNode && (g.parentNode.removeChild(g), (g = null)),
              m ||
                ((m = !0),
                h(
                  "¡Hola! 👋 Soy <b>Axo</b>, tu asistente virtual de <b>MetaEducación</b>.\n\n¿En qué puedo ayudarte? Puedes escribirme o usar los botones rápidos de abajo. 😊",
                )));
            setTimeout(() => l.focus(), 400);
          })();
    }),
    i && i.addEventListener("click", f),
    d && d.addEventListener("click", y),
    l && l.addEventListener("keypress", (e) => {
      "Enter" === e.key && y();
    }),
    u.forEach((e) => {
      e.addEventListener("click", () => {
        const a = e.dataset.question;
        (v(
          {
    ...
    document.addEventListener("click", (e) => {
      !p || r.contains(e.target) || s.contains(e.target) || f();
    }),
    r && r.addEventListener("click", (e) => {
      e.stopPropagation();
    }),
    document.querySelectorAll(".modality-card-inner").forEach((e) => {
      e.addEventListener("click", () => {
