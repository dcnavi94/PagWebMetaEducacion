        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            links.forEach(link => {
                link.addEventListener('click', (e) => {
                    ...
                    if (targetId === 'view-biblioteca-admin') loadLibraryAdmin();
                    if (targetId === 'view-laboratorio-admin') loadLabAdmin();
                    if (targetId === 'view-horarios-admin') initializeScheduleAdmin();
