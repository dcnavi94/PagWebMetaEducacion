...
import { testvocacionalHtml } from './TestVocacionalContent';
...
const TestVocacional = () => {
  ...
  return (
    <div className="test-vocacional-layout" ref={containerRef} dangerouslySetInnerHTML={{ __html: testvocacionalHtml }} />
  );
};
