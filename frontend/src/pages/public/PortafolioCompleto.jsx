...
import { PortafolioCompletoHtml } from './PortafolioCompletoContent';
...
const PortafolioCompleto = () => {
  ...
  return (
    <div className="migrated-layout" ref={containerRef} dangerouslySetInnerHTML={{ __html: PortafolioCompletoHtml }} />
  );
};
