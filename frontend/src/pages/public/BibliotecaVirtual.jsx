...
import { BibliotecaVirtualHtml } from './BibliotecaVirtualContent';
...
const BibliotecaVirtual = () => {
  ...
  return (
    <div className="migrated-layout" ref={containerRef} dangerouslySetInnerHTML={{ __html: BibliotecaVirtualHtml }} />
  );
};
